...
namespace API_PORTAL.Migrations
{
    ...
    [Migration("20260903100637_AddPortalUserTotp")]
    partial class AddPortalUserTotp
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("API_PORTAL.Entities.Base.AccountToken", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("account_token", "portal", t =>
                        {
            ...
            modelBuilder.Entity("API_PORTAL.Entities.InboundRequest", b =>
                {
                    ...
                    b.ToTable("user", "portal", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_user_role", "role IN ('Citizen', 'Admin')");
                        });
                });

            modelBuilder.Entity("API_PORTAL.Entities.UserTotp", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
