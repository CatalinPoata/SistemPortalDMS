...
{
    public interface IDmsCancellationClient
    {
    ...
    public sealed class DmsCancellationClient : IDmsCancellationClient
    {
        private readonly HttpClient httpClient;
        private readonly DmsIntegrationOptions options;

        public DmsCancellationClient(
            ...
            CancellationToken cancellationToken)
        {
            ...
            var entryId = message.payload.RootElement
                .GetProperty("entryId")
                .GetGuid();
            ...
            {
                return new DmsRegistrationDeliveryResult(
                    false, true, null, Trim(exception.Message));
            }
