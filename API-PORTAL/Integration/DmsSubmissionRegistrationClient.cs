...
{
    public sealed record DmsRegistrationDeliveryResult(
        bool Delivered,
        bool Retryable,
        string? ResponseBody,
        string? Error);

    public interface IDmsSubmissionRegistrationClient
    {
    ...
    public sealed class DmsSubmissionRegistrationClient
        : IDmsSubmissionRegistrationClient
    {
        private readonly HttpClient httpClient;
        private readonly DmsIntegrationOptions options;

        public DmsSubmissionRegistrationClient(
