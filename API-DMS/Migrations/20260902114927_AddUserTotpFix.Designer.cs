...
namespace API_DMS.Migrations
{
    ...
    [Migration("20260902114927_AddUserTotpFix")]
    partial class AddUserTotpFix
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("API_DMS.Entities.AccountToken", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTimeOffset?>("consumed_at")
                    ...
                    b.HasIndex("user_id", "purpose");

                    b.ToTable("account_token", "dms", t =>
                        {
                            t.HasCheckConstraint("CK_account_token_hash_length", "length(token_hash) <= 128");

                            t.HasCheckConstraint("CK_account_token_purpose", "purpose IN ('EmailConfirmation', 'PasswordReset')");
                        });
                });
            ...
            modelBuilder.Entity("API_DMS.Entities.RegistryEntry", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("applicant_name"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("applicant_name"), new[] { "gin_trgm_ops" });
                    ...
                    b.ToTable("user", "dms", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_user_role", "role IN ('Clerk', 'Admin')");
                        });
                });

            modelBuilder.Entity("API_DMS.Entities.UserTotp", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("enabled_at")
                        .HasColumnType("timestamptz");
                    ...
                    b.Property<long?>("last_used_counter")
                        .HasColumnType("bigint");

                    b.Property<string>("protected_secret")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<JsonDocument>("recovery_code_hashes")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("user_totp", "dms", t =>
                        {
                            t.HasCheckConstraint("CK_user_totp_secret_length", "length(protected_secret) <= 2048");
                        });
                });
